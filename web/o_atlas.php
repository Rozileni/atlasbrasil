...
<div class="contentPages">
    <div class="containerPage">
        ...
        <div id="conteudo_atlas">
            <?php
                    if($separator[1] == 'o_atlas_' || $separator[1] == ''){
                        include $_SESSION["lang"].'/o_atlas_.php';
                    }

                    else if($separator[1] == 'quem_faz'){
                        include $_SESSION["lang"].'/quem_faz.php';
                    }

                    else if($separator[1] == 'para_que'){
                        include $_SESSION["lang"].'/para_que.php';
                    }
                    else if($separator[1] == 'processo'){
                        include $_SESSION["lang"].'/processo.php';
                    }
                    else if($separator[1] == 'desenvolvimento_humano'){
                        include $_SESSION["lang"].'/desenvolvimento_humano.php';
                    }
                    else if($separator[1] == 'idhm'){
                        include $_SESSION["lang"].'/idhm.php';
                    }
                        ...
                        include $_SESSION["lang"].'/glossario.php';
                    }

                    else if($separator[1] == 'perguntas_frequentes'){
                        include $_SESSION["lang"].'/perguntas_frequentes.php';
                    }
