<?php
    ...
    #Destaques
    else if($pag == 'destaques' && $pagNext == 'metodologia'){
        include 'web/pt/destaques/metodologia.php';
    }
    ...
    {
        include 'com/mobiliti/rm/ui.regioesmetropolitanas.php';
    }
