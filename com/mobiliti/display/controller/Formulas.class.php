...
class Formulas {
    ...
    static public function getSituacaoIDH($idhm) {
    ...
    static public function getDimensao($idhm_r, $idhm_l, $idhm_e, $confDimensao) {
    ...
    static public function printTablePopulacao($block_table_populacao, $variaveis){
    ...
    static public function printTableHabitacao($block_table_habitacao, $variaveis){
