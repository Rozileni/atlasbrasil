            ...
            if ($value["id"] == TextBuilder::$idMunicipio) {
                ...
                foreach ($idhm_igual as &$value2) {
                    if ($value2["id"] == TextBuilder::$idMunicipio) {
                        ...
                        $texto->replaceTags("municipios_pior_IDHM", TextBuilder::my_number_format(count($ranking) - ($var[0]['posicao_idh']),0));
                        $texto->replaceTags("municipios_pior_IDHM_p", number_format(((count($ranking) - ($var[0]['posicao_idh'])) / count($ranking)) * 100, 2, ",", "."));
                        break;
                    }
                    $count_iguais++;
                }
            ...
            if ($value["id"] == TextBuilder::$idMunicipio) {
                ...
                foreach ($idhm_igual as &$value2) {
                    if ($value2["id"] == TextBuilder::$idMunicipio) {
                        ...
                        $texto->replaceTags("municipios_pior_IDHM_estado", TextBuilder::my_number_format((count($ranking_uf) - ($var[0]['posicao_e_idh'])),0));
                        $texto->replaceTags("municipios_pior_IDHM_p_estado", number_format(((count($ranking_uf) - ($var[0]['posicao_e_idh'])) / count($ranking_uf)) * 100, 2, ",", "."));
                        break;
                    }
                    $count_iguais++;
                }
