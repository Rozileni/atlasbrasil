...
class TextBuilder_EN {
    ...
    static public function generateIDH_componente($block_componente) {
        ...
        $block_componente->setData("fonte", Formulas::$fontePerfil);
        $block_componente->setData("titulo", "IDHM");
        $block_componente->setData("canvasContent", getChartDesenvolvimentoHumano(TextBuilder_EN::$idMunicipio));
        ...
        $str = "<p align='justify'>The Municipal Human Development Index (IDHM) of [municipio] is [idh] in [2010].
            The municipality is located in the range of Human Development [Faixa_DH].            
            Between 2000 and 2010, the size that grew most in absolute terms was [Dimensao2000a2010].                        
            Between 1991 and 2000, the size that grew most in absolute terms was [Dimensao1991a2000].</p>";
   ...
   static function my_number_format($number,$decimais=2,$separador_decimal=",",$separador_milhar="."){ 
    ...
    static public function generateIDH_evolucao($block_evolucao) {
        ...
        $block_evolucao->setData("canvasContent", getChartEvolucao(TextBuilder_EN::$idMunicipio));
    }
    ...
    static public function generateIDH_ranking($block_ranking) {
        ...
        if (TextBuilder_EN::$idMunicipio != 735){
        ...
        $sqlinha = "select posicao_idh,posicao_e_idh from rank where fk_municipio = ".TextBuilder_EN::$idMunicipio ." AND fk_ano_referencia = 3";
        $var = TextBuilder_EN::$bd->ExecutarSQL($sqlinha, "sqlinha_teste");
        ...
        foreach ($ranking as &$value) {
            if ($value["id"] == TextBuilder_EN::$idMunicipio) {
                $texto->replaceTags("ranking_municipio_IDHM", $var[0]['posicao_idh']);
                $idhm_igual = TextBuilder_EN::getIDHM_Igual($value["valor"]); //IDHM

                $count_iguais = 1;
                foreach ($idhm_igual as &$value2) {
                    if ($value2["id"] == TextBuilder_EN::$idMunicipio) {
                        ...
                        $texto->replaceTags("municipios_pior_IDHM", TextBuilder_EN::my_number_format(count($ranking) - ($var[0]['posicao_idh'] - 1),0));
        ...
        foreach ($ranking_uf as &$value) {
            if ($value["id"] == TextBuilder_EN::$idMunicipio) {
                ...
                $idhm_igual = TextBuilder_EN::getIDHM_Igual_Uf($value["valor"], $uf[0]["id"]); //IDHM
                ...
                foreach ($idhm_igual as &$value2) {
                    if ($value2["id"] == TextBuilder_EN::$idMunicipio) {
                        ...
                        $texto->replaceTags("municipios_pior_IDHM_estado", TextBuilder_EN::my_number_format((count($ranking_uf) - ($var[0]['posicao_e_idh'] - 1)),0));
    ...
    static public function generateIDH_table_populacao($block_table_populacao) {
        ...
        for ($i = 1; $i <= count($variaveis); $i++) {
            if ($i != 6) {
                ...
                $block_table_populacao->setData("v$i" . "_a1", TextBuilder_EN::my_number_format($variaveis[$i - 1][0]["valor"],0)); // Ano 1 (1991)
                $block_table_populacao->setData("v$i" . "__a1", number_format((($variaveis[$i - 1][0]["valor"] / $variaveis[0][0]["valor"]) * 100), 2, ",", ".")); // Ano 1 (1991)
                $block_table_populacao->setData("v$i" . "_a2", TextBuilder_EN::my_number_format($variaveis[$i - 1][1]["valor"],0)); // Ano 2 (2000)
                $block_table_populacao->setData("v$i" . "__a2", number_format((($variaveis[$i - 1][1]["valor"] / $variaveis[0][1]["valor"]) * 100), 2, ",", ".")); // Ano 2 (2000)
                $block_table_populacao->setData("v$i" . "_a3", TextBuilder_EN::my_number_format($variaveis[$i - 1][2]["valor"],0)); // Ano 3 (2010)
    ...
    static public function generateIDH_table_etaria($block_table_etaria) {
        ...
        for ($i = 1; $i <= count($variaveis); $i++) {
            if ($i == 1) {
                ...
                $block_table_etaria->setData("v$i" . "_a1", TextBuilder_EN::my_number_format($pesotot[0]["valor"] - $variaveis[$i - 1][0]["valor"],0)); // Ano 1 (1991)
                $block_table_etaria->setData("v$i" . "__a1", number_format((($pesotot[0]["valor"] - $variaveis[$i - 1][0]["valor"]) / $pesotot[0]["valor"]) * 100, 2, ",", ".")); // Ano 1 (1991)
                $block_table_etaria->setData("v$i" . "_a2", TextBuilder_EN::my_number_format($pesotot[1]["valor"] - $variaveis[$i - 1][1]["valor"],0)); // Ano 2 (2000)
                $block_table_etaria->setData("v$i" . "__a2", number_format((($pesotot[1]["valor"] - $variaveis[$i - 1][1]["valor"]) / $pesotot[1]["valor"]) * 100, 2, ",", ".")); // Ano 2 (2000)
                $block_table_etaria->setData("v$i" . "_a3", TextBuilder_EN::my_number_format($pesotot[2]["valor"] - $variaveis[$i - 1][2]["valor"],0)); // Ano 3 (2010)
                ...
                $block_table_etaria->setData("v$i" . "_a1", TextBuilder_EN::my_number_format($variaveis[$i - 2][0]["valor"] - $variaveis[$i][0]["valor"],0)); // Ano 1 (1991)
                ...
                $block_table_etaria->setData("v$i" . "_a2", TextBuilder_EN::my_number_format($variaveis[$i - 2][1]["valor"] - $variaveis[$i][1]["valor"],0)); // Ano 2 (2000)
                ...
                $block_table_etaria->setData("v$i" . "_a3", TextBuilder_EN::my_number_format($variaveis[$i - 2][2]["valor"] - $variaveis[$i][2]["valor"],0)); // Ano 3 (2010)
                ...
                $block_table_etaria->setData("v$i" . "_a1", TextBuilder_EN::my_number_format($variaveis[$i - 1][0]["valor"],0)); // Ano 1 (1991)
                $block_table_etaria->setData("v$i" . "__a1", number_format(($variaveis[$i - 1][0]["valor"] / $pesotot[0]["valor"]) * 100, 2, ",", ".")); // Ano 1 (1991)
                $block_table_etaria->setData("v$i" . "_a2", TextBuilder_EN::my_number_format($variaveis[$i - 1][1]["valor"],0)); // Ano 2 (2000)
                $block_table_etaria->setData("v$i" . "__a2", number_format(($variaveis[$i - 1][1]["valor"] / $pesotot[1]["valor"]) * 100, 2, ",", ".")); // Ano 2 (2000)
                $block_table_etaria->setData("v$i" . "_a3", TextBuilder_EN::my_number_format($variaveis[$i - 1][2]["valor"],0)); // Ano 3 (2010)
        ...
        $block_table_etaria->setData("canvasContent1", getChartPiramideEtaria1(TextBuilder_EN::$idMunicipio));
        $block_table_etaria->setData("canvasContent2", getChartPiramideEtaria2(TextBuilder_EN::$idMunicipio));    
        $block_table_etaria->setData("canvasContent3", getChartPiramideEtaria3(TextBuilder_EN::$idMunicipio));
...
//        $t_freq4a6 = TextBuilder_EN::getVariaveis_table(TextBuilder_EN::$idMunicipio, "T_FREQ4A6"); //T_FREQ4A6 
//        $t_fund12a14 = TextBuilder_EN::getVariaveis_table(TextBuilder_EN::$idMunicipio, "T_FUND12A14");  //T_FUND12A14 
//        $t_fund16a18 = TextBuilder_EN::getVariaveis_table(TextBuilder_EN::$idMunicipio, "T_FUND16A18");  //T_FUND16A18 
//        $t_med19a21 = TextBuilder_EN::getVariaveis_table(TextBuilder_EN::$idMunicipio, "T_MED19A21");  //T_MED19A21 
        ...
        $block_nivel_educacional->setData("canvasContent1", getChartFluxoEscolar(TextBuilder_EN::$idMunicipio));
        ...
        $block_nivel_educacional->setData("canvasContent2", getChartFrequenciaEscolar(TextBuilder_EN::$idMunicipio));
        ...
        $block_nivel_educacional->setData("canvasContent3", getChartFrequenciaDe6a14(TextBuilder_EN::$idMunicipio));
              
        $block_nivel_educacional->setData("canvasContent4", getChartFrequenciaDe15a17(TextBuilder_EN::$idMunicipio));
        $block_nivel_educacional->setData("canvasContent5", getChartFrequenciaDe18a24(TextBuilder_EN::$idMunicipio));
...
//        $t_analf25m = TextBuilder_EN::getVariaveis_table(TextBuilder_EN::$idMunicipio, "T_ANALF25M"); //T_ANALF25M  
//        $t_fundin25m = TextBuilder_EN::getVariaveis_table(TextBuilder_EN::$idMunicipio, "T_FUND25M");  //T_FUNDIN25M 
//        $t_medin25m = TextBuilder_EN::getVariaveis_table(TextBuilder_EN::$idMunicipio, "T_MED25M");  //T_MEDIN25M 
...
//        $t_analf25m_uf = TextBuilder_EN::getVariaveis_Uf(TextBuilder_EN::$idMunicipio, "T_ANALF25M"); //T_ANALF25M  
//        $t_fundin25m_uf = TextBuilder_EN::getVariaveis_Uf(TextBuilder_EN::$idMunicipio, "T_FUND25M");  //T_FUNDIN25M 
//        $t_medin25m_uf = TextBuilder_EN::getVariaveis_Uf(TextBuilder_EN::$idMunicipio, "T_MED25M");  //T_MEDIN25M 
        
        //$t_analf25m_uf = TextBuilder_EN::getVariaveis_Uf(TextBuilder_EN::$idMunicipio, "T_ANALF18M"); //T_ANALF18M - Mudou variável 
        ...
        $block_populacao_adulta->setData("canvasContent", getChartEscolaridadePopulacao(TextBuilder_EN::$idMunicipio));
...
//            $block_renda->setData("quebra", "");
    ...
    static public function generateTRABALHO1($block_trabalho) {
        ...
        $block_trabalho->setData("canvasContent", getChartTrabalho(TextBuilder_EN::$idMunicipio));
